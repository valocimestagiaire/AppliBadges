...
<html>
	...
	<script>
		function choixSelect(){
			...
			if(value == "alarme"){
				document.getElementById("selectAlarme").className = "afficher";
				document.getElementById("Id_badge").className = "cacher";
			}else{
				document.getElementById("Id_badge").className = "afficher";
				document.getElementById("selectAlarme").className = "cacher";
			}
		}
	</script>
</html>
